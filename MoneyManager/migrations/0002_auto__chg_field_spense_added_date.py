...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spense.added_date'
        db.alter_column(u'MoneyManager_spense', 'added_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Spense.added_date'
        db.alter_column(u'MoneyManager_spense', 'added_date', self.gf('django.db.models.fields.DateField')())
